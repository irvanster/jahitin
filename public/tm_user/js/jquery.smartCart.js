...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemQtyTemplate: '<p>{display_price} × {display_quantity} = {display_amount} <br> <a class="button button-fill color-green">Jahit Ini</a></p>',
        ...
        lang: { // Language variables
            cartTitle: "Keranjang Jahitan",
            checkout: 'Jahit',
            clear: 'Hapus Semua',
            subtotal: 'Subtotal:',
            cartRemove: '<i class="fas fa-trash-alt" ></i>',
            cartEmpty: 'Keranjang Kosong silahkan Pilih <a href="" onclick="timeline()"><b>Desain</b></a> yang ingin Di Jahit.'
        },
        submitSettings: {
            submitType: 'form', // form, paypal, ajax
            ajaxURL: 'plugin/cart.php', // Ajax submit URL
        ...
        _addToCart: function (p) {
            ...
            if (this.options.combineProducts) {
                ...
                if (pf.length > 0) {
                    ...
                    $('#jht').removeClass('animated swing infinite');
                } else {
                    this.cart.push(p);
