                            ...
                            <tbody>
                                ...
                                @foreach ($lists as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success" class="btn btn-info">Cetak Form</button>
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#formPengukuran">Input Data</button>
                                    ...
                                    @include('back.pesananJahitan.modalFormPengukuran')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
